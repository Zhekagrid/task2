...
import com.hridziushka.task2.builder.StaxMedicalProductBuilder;
...
public class StaxMedicalProductBuilderTest {
    ...
    public void test() {
        ...
        AbstractMedicalProductBuilder builderStax = new StaxMedicalProductBuilder();


        builderStax.buildMedproductList(XML_CORRECT_PATH);
        List<AbstractMedicalProduct> actual = builderStax.getMedProducts();
