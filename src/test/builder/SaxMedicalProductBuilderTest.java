...
import com.hridziushka.task2.builder.SaxMedicalProductBuilder;
...
public class SaxMedicalProductBuilderTest {
    ...
    public void test() throws CustomException {
        ...
        AbstractMedicalProductBuilder builderSax = new SaxMedicalProductBuilder();


        builderSax.buildMedproductList(XML_CORRECT_PATH);
        List<AbstractMedicalProduct> actual = builderSax.getMedProducts();
